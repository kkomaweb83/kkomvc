...
<a href="${ct_path}/pro_main_prelist.do?dana=pro_main_prelist&pro_pcl_no=0101"> 
...
<a href="${ct_path}/sct_odr_doc.do?dana=sct_odr_doc&sct_mem_no=${login.mem_no }&sct_pro_muti=1">
