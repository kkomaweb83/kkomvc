...
<script type="text/javascript">
	...
	function goProInsert(){
		...
		if (document.pro_insert.pro_mkr_no.value == "")  {
	 	...
	 	if (document.getElementsByName("pmg_file_s1_mp")[0].value == "")  {
	        alert("작은이미지를 선택하세요!");
	        document.getElementsByName("pmg_file_s1_mp")[0].focus();
	        return;
	 	}

	 	if (document.getElementsByName("pmg_file_s2_mp")[0].value == "")  {
	        alert("큰이미지를 선택하세요!");
	        document.getElementsByName("pmg_file_s2_mp")[0].focus();
	        return;
	 	}
...
<body>
	...
	<td align="left" colspan="3">
	<input type="file" name="pmg_file_s1_mp" size="70" class="box_input_left" /></td>
	</tr>
	<tr>
	<td><span class="span_box2">큰 이미지</span></td>
	<td align="left" colspan="3">
	<input type="file" name="pmg_file_s2_mp" size="70" class="box_input_left" /></td>
	</tr>
	</table>
	</div>
